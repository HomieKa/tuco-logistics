<template>
  <div>
    <PageHeader
      title="Insights for high-performing freight teams"
      description="Stay ahead with TUCO perspectives on carrier strategy, technology, and commercial optimisation."
    >
      <template #eyebrow>Resources</template>
    </PageHeader>
