    ...
    <div class="container mx-auto px-4 py-12">
      <div class="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
        <div>
          ...
          <div class="space-y-2 text-[#e9f5f7]">
            <div class="flex items-center">
              ...
              <a
                href="tel:1300853074"
                class="text-[#e9f5f7] transition hover:text-white"
                >1300 853 074</a
              >
            </div>
            <div class="flex items-center">
        ...
        <div>
          ...
          <ul class="space-y-2 text-[#e9f5f7]">
            <li>
              <RouterLink
                to="/our-team"
                class="text-[#e9f5f7] transition hover:text-white"
      ...
      <div
        class="flex flex-col items-center justify-between border-t border-navy-400 pt-8 text-sm text-white md:flex-row"
      >
        <p class="mb-4 md:mb-0 text-white">
        ...
        <div class="flex space-x-6">
          ...
          >
          <RouterLink to="/terms" class="text-white transition hover:text-white"
